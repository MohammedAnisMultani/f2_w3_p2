...
let arr1 = ["ID", "Name", "Gender", "Class", "Marks", "Passing", "Email"];

arr1.forEach((headerText, index)=>{
    const cellH = rowH.insertCell(index)
    cellH.innerText = headerText
})
...
let array = [{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
...
array.forEach((value, index)=>{
    ...
    idCell.innerText = array[index].id
    nameCell.innerText = `${array[index].first_name} ${array[index].last_name}`
    genderCell.innerText = `${array[index].gender}`
    classCell.innerText = `${array[index].class}`
    marksCell.innerText = `${array[index].marks}`
    passingCell.innerText = `${array[index].passing}`
    emailCell.innerText = `${array[index].email}`
...
let azBtn = document.getElementById("atoz")
let zaBtn = document.getElementById("ztoa")
let marksBtn = document.getElementById("marks")
let passingBtn = document.getElementById("passing")
let classBtn = document.getElementById("class")
let genderBtn = document.getElementById("gender")

azBtn.addEventListener("click", azSorting)
